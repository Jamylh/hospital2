								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">إدارة الأطباء</h2>
										
											<p class="cl-effect-1">
												<a href="manage-doctors.php">
												<?php $result1 = mysqli_query($connection,"SELECT * FROM doctors ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											عدد الأطباء: <?php echo htmlentities($num_rows1);  } ?>		
												</a>
									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												...
												<?php $sql= mysqli_query($connection,"SELECT * FROM appointment");
