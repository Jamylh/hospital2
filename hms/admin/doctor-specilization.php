...
{
$sql=mysqli_query($connection,"insert into doctorSpecilization(specilization) values('".$_POST['doctorspecilization']."')");
$_SESSION['msg']="Doctor Specialization added successfully !!";
}

if(isset($_GET['del']))
		  {
		          mysqli_query($connection,"delete from doctorSpecilization where id = '".$_GET['id']."'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">إضافة تخصصات الأطباء</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>الإدارة</span>
									...
									<li class="active">
										<span>إضافة تخصصات الأطباء</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title"> إضافة تخصص الطبيب </h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">إدارة<span class="text-bold">تخصص الطبيب</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th>التخصص</th>
												<th class="hidden-xs">تاريخ الإنشاء</th>
												<th>تاريخ التعديل</th>
												<th>حذف\تعدديل</th>
										...
										<tbody>
<?php
$sql=mysqli_query($connection,"select * from doctorSpecilization");
$cnt=1;
