...
{
$sql=mysqli_query($connection,"update  doctorSpecilization set specilization='".$_POST['doctorspecilization']."', updationDate='$currentTime'where id='$id'");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">تعديل التخصصات</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>الإدارة</span>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">تعديل تخصص </h5>
												</div>
...
$id=intval($_GET['id']);
	$sql=mysqli_query($connection,"select * from doctorSpecilization where id='$id'");
