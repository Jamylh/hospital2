...
$sql=mysqli_query($connection,"Update users set fullName='$fname',address='$address',city='$city',gender='$gender' where email='".$_SESSION['login']."'");
if($sql)
{
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<?php $sql=mysqli_query($connection,"select * from users where email='".$_SESSION['login']."'");
