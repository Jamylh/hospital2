                             ...
                             <div class="content-grids">
                                          <div class="row">
                                                <div class="col-sm"> 
                                                    ...
                                                    <p class="btmspace-30"> التواصل مع الاداره للاقتراحات والشكاوي</p>
                                                    <footer><div class="button"><span><a href="hms/admin">اضغط هنا</a></span></div></footer>
                                                  </article></div>
                                                <div class="col-sm"> 
                                                    <article><i class="fas fa-user-nurse fa-3x"></i>
                                                    <h6 class="heading font-x1">الأطباء</h6>
                                                    <p class="btmspace-30">تعرف على افضل الاطباء لدنيا</p>
                                                    <footer> <div class="button"><span><a href="hms/doctor/">اضغط هنا</a></span></div></footer>
                                                  </article></div>
                                                <div class="col-sm"> 
                                                    <article><i class="fas fa-heartbeat fa-3x"></i></i>
                                                    <h6 class="heading font-x1">اللياقة</h6>
                                                    <p class="btmspace-30">التسجيل وحجز الموعد</p>
                                                    <footer>  <div class="button"><span><a href="hms/user-login.php">اضغط هنا</a></span></div></footer>
                                                  </article></div>
                                              </div>
                             </div>
                             <!-- end content-grids -->
